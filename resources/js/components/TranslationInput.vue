<template>
    <div class="flex">
        <svg
            v-show="!isActive && isLoading"
            class="cursor-pointer fill-current w-4 h-4 mr-2"
        ...
        <svg
            v-show="!isActive && hasSaved"
            class="cursor-pointer fill-current text-success w-4 h-4 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            @click="setActive"
        >
        ...
        <svg
            v-show="!isActive && hasErrored"
            class="cursor-pointer fill-current text-danger w-4 h-4 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            @click="setActive"
        >
        ...
        <svg
            v-show="!isActive && !hasSaved && !hasErrored && !isLoading"
            class="cursor-pointer fill-current w-4 h-4 mr-2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            @click="setActive"
...
export default {
    ...
    methods: {
        ...
        storeTranslation: function () {
            ...
            this.isLoading = true
            axios
                .put(`/nova-vendor/nova-translation/languages/${this.language}/translations`, {
